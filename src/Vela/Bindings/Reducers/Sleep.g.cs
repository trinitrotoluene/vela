...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void SleepHandler(ReducerEventContext ctx, SpacetimeDB.Types.PlayerSleepRequest request);
        public event SleepHandler? OnSleep;

        public void Sleep(SpacetimeDB.Types.PlayerSleepRequest request)
        {
