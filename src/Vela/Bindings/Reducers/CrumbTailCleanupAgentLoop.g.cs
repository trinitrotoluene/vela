...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void CrumbTailCleanupAgentLoopHandler(ReducerEventContext ctx, SpacetimeDB.Types.CrumbTrailCleanupTimer timer);
        public event CrumbTailCleanupAgentLoopHandler? OnCrumbTailCleanupAgentLoop;

        public void CrumbTailCleanupAgentLoop(SpacetimeDB.Types.CrumbTrailCleanupTimer timer)
        {
