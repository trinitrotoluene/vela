...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void EmpireAddSiegeSuppliesHandler(ReducerEventContext ctx, SpacetimeDB.Types.EmpireAddSiegeSuppliesRequest request);
        public event EmpireAddSiegeSuppliesHandler? OnEmpireAddSiegeSupplies;

        public void EmpireAddSiegeSupplies(SpacetimeDB.Types.EmpireAddSiegeSuppliesRequest request)
        {
