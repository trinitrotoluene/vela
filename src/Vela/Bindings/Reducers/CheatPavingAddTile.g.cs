...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void CheatPavingAddTileHandler(ReducerEventContext ctx, SpacetimeDB.Types.PlayerPavingPlaceTileRequest request);
        public event CheatPavingAddTileHandler? OnCheatPavingAddTile;

        public void CheatPavingAddTile(SpacetimeDB.Types.PlayerPavingPlaceTileRequest request)
        {
