...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void ImportEmpireIconDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<EmpireIconDesc> records);
        public event ImportEmpireIconDescHandler? OnImportEmpireIconDesc;

        public void ImportEmpireIconDesc(System.Collections.Generic.List<EmpireIconDesc> records)
        {
