...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void PlayerRegenAgentLoopHandler(ReducerEventContext ctx, SpacetimeDB.Types.PlayerRegenLoopTimer timer);
        public event PlayerRegenAgentLoopHandler? OnPlayerRegenAgentLoop;

        public void PlayerRegenAgentLoop(SpacetimeDB.Types.PlayerRegenLoopTimer timer)
        {
