...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void ClaimTakeOwnershipHandler(ReducerEventContext ctx, SpacetimeDB.Types.PlayerClaimTakeOwnershipRequest request);
        public event ClaimTakeOwnershipHandler? OnClaimTakeOwnership;

        public void ClaimTakeOwnership(SpacetimeDB.Types.PlayerClaimTakeOwnershipRequest request)
        {
