...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void AttackImpactMigratedHandler(ReducerEventContext ctx, SpacetimeDB.Types.AttackImpactTimerMigrated timer);
        public event AttackImpactMigratedHandler? OnAttackImpactMigrated;

        public void AttackImpactMigrated(SpacetimeDB.Types.AttackImpactTimerMigrated timer)
        {
