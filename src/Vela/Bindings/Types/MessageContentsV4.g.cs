...
{
    [SpacetimeDB.Type]
    public partial record MessageContentsV4 : SpacetimeDB.TaggedEnum<(
        InterModuleTableUpdatesV2 TableUpdate,
        TransferPlayerMsgV4 TransferPlayerRequest,
        ...
        OnDeployableRecoveredMsgV2 OnDeployableRecovered,
        ...
        EmpireWithdrawItemMsg EmpireWithdrawItem
    )>;
}
