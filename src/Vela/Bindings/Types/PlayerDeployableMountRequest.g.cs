...
namespace SpacetimeDB.Types
{
    [SpacetimeDB.Type]
    [DataContract]
    public sealed partial class PlayerDeployableMountRequest
    {
        [DataMember(Name = "deployable_entity_id")]
        public ulong DeployableEntityId;

        public PlayerDeployableMountRequest(ulong DeployableEntityId)
        {
            this.DeployableEntityId = DeployableEntityId;
        }

        public PlayerDeployableMountRequest()
        {
        }
    }
}
